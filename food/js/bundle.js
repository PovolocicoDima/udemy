...
function calc () {
    ...
    calcTotal(); // вызывать надо в нескольких местах,
    // чтобы при каждом изменении значении на сайте 
    // функция корректно пересчитывала значение
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2020-09-18');
