...
/* harmony import */ var _modules_drop__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/drop */ "./src/js/modules/drop.js");
 ...
 // import filterTest from './modules/filter_test';
// import pictureSizedTest from './modules/pictureSizedTest';
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_12__["default"])(); // filterTest();
  // pictureSizedTest('.sizes-block');
});
...
//     blocks.classList.add('animated', 'fadeInDown');
// });
// btns.forEach(btn => {
//     btn.addEventListener('click', function() {
...
var drop = function drop() {
  ...
  // dragend  *
  // dragexit  *
  // dragener - объект над dropArea
  // dragleave - объект за пределами dropArea
  // dragover - объект зависает над дропареа
  // drop - объект отправлен в дровареа
...
var filter = function filter() {
  ...
  function render(selector, className) {}
